...
void update(int o,int l,int r,int val){
    ...
    if(mid>=r)        
    update(o+o,l,r,val);    
    else if(l>mid) update(o+o+1,l,r,val);     
        else {        
